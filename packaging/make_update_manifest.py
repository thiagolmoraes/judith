...
uploads):
    ...
    Judith-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    Judith-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
ARTIFACTS = {
    "Judith-macos-arm64.app.tar.gz": "darwin-aarch64",
    "Judith-windows-setup.exe": "windows-x86_64",
}
