...
ASSISTANT_INSTRUCTIONS = (
    ...
    "A message that arrives from a platform carries a reply handle, like "
    "`[WhatsApp DM · Ana | reply→whatsapp_evolution:5511…]`. That handle IS the "
    "conversation for that message: answer it by calling send_message with the target "
    "after `reply→`, because plain text goes to the app window, which the person who "
    "wrote to you is not looking at. Reply in the language the message was written in. "
