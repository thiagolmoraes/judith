// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real Judith mark
...
test("boot splash shows the Judith star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting Judith|Restoring your session/)).toBeVisible();
});
